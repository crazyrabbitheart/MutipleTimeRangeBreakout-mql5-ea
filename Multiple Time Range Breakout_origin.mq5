...
input double TP = 0; // TP: Take-profit
input double SL = 0; // SL: Stop-loss
input double SDistance = 1; // SDistance: Fluff distance from recent SL in points
input double TDistance = 1; // TDistance: Fluff distance from recent TP in points
